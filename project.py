class Pet:
    def __init__(self, name, hunger=50, energy=50, happiness=15, instincts=[]):
        self.name = name
...
my_pet.instincts.append("test")
my_pet2 = Pet("Joseph1")

print(my_pet.instincts)
print(my_pet2.instincts)
...
# # pet_default = Pet(
# #     "Mia", hunger=50, energy=50, happiness=20, instincts=["purr", "climb"]
# # )
# # # print(pet_default)

# # pet_default.instincts.append("ouu")
# # print(pet_default)
